 ...
 */
class FAmethystAllTimeMatchResultsRead : public FOnlineLeaderboardRead
{
public:

	FAmethystAllTimeMatchResultsRead()
	{
		// Default properties
		LeaderboardName = FName(TEXT("AmethystAllTimeMatchResults"));
 ...
 */
class FAmethystAllTimeMatchResultsWrite : public FOnlineLeaderboardWrite
{
public:

	FAmethystAllTimeMatchResultsWrite()
	{
		// Default properties
		new (LeaderboardNames) FName(TEXT("AmethystAllTimeMatchResults"));
