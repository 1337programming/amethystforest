...
#include "AmethystExplosionEffect.h"

AAmethystExplosionEffect::AAmethystExplosionEffect(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void AAmethystExplosionEffect::BeginPlay()
{
	Super::BeginPlay();
...
void AAmethystExplosionEffect::Tick(float DeltaSeconds)
{
