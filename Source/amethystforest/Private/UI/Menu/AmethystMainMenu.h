...
#include "Widgets/SAmethystServerList.h"
#include "Widgets/SAmethystDemoList.h"
#include "Widgets/SAmethystLeaderboard.h"
#include "Widgets/SAmethystSplitScreenLobbyWidget.h"
...
public:	
	...
	/** build menu */
	void Construct(TWeakObjectPtr<UAmethystForestInstance> _GameInstance, TWeakObjectPtr<ULocalPlayer> _PlayerOwner);
...
protected:
	...
	TWeakObjectPtr<UAmethystForestInstance> GameInstance;
	...
	TSharedPtr<class SAmethystSplitScreenLobby> SplitScreenLobbyWidget;

	/* used for removing the SplitScreenLobby */
	TSharedPtr<class SWeakWidget> SplitScreenLobbyWidgetContainer;

	/** server list widget */
	TSharedPtr<class SAmethystServerList> ServerListWidget;

	/** demo list widget */
	TSharedPtr<class SAmethystDemoList> DemoListWidget;

	/** leaderboard widget */
	TSharedPtr<class SAmethystLeaderboard> LeaderboardWidget;

	/** custom menu */
	TSharedPtr<class FAmethystMenuItem> JoinServerItem;

	/** yet another custom menu */
	TSharedPtr<class FAmethystMenuItem> LeaderboardItem;

	/** Custom demo browser menu */
	TSharedPtr<class FAmethystMenuItem> DemoBrowserItem;

	/** LAN Options */
	TSharedPtr<class FAmethystMenuItem> HostLANItem;
	TSharedPtr<class FAmethystMenuItem> JoinLANItem;

	/** Record demo option */
	TSharedPtr<class FAmethystMenuItem> RecordDemoItem;
	...
	TSharedPtr<FAmethystMenuItem> HostOfflineMapOption;
	TSharedPtr<FAmethystMenuItem> HostOnlineMapOption;
	TSharedPtr<FAmethystMenuItem> JoinMapOption;
	...
	void LanMatchChanged(TSharedPtr<FAmethystMenuItem> MenuItem, int32 MultiOptionIndex);

	/** record demo option changed callback */
	void RecordDemoChanged(TSharedPtr<FAmethystMenuItem> MenuItem, int32 MultiOptionIndex);
	...
	TSharedPtr<class SAmethystConfirmationDialog> QuickMatchFailureWidget;
	...
	TSharedPtr<class SAmethystConfirmationDialog> QuickMatchSearchingWidget;
	...
	TSharedPtr<class SAmethystConfirmationDialog> QuickMatchStoppingWidget;
