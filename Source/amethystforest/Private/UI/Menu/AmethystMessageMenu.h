...
class UAmethystForestInstance;

class FAmethystMessageMenu : public TSharedFromThis<FAmethystMessageMenu>
{
public:
	/** build menu */
	void Construct(TWeakObjectPtr<UAmethystForestInstance> InGameInstance, TWeakObjectPtr<ULocalPlayer> InPlayerOwner, const FText& Message, const FText& OKButtonText, const FText& CancelButtonText,  const FName& InPendingNextState);
