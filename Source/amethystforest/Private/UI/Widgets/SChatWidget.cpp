...
{
	AmethystHUDPCTrackerBase::Init(InContext);

	ChatStyle = &FAmethystStyle::Get().GetWidgetStyle<FAmethystChatStyle>("DefaultAmethystChatStyle");
	...
	[
		...
		[
			...
			[
				...
				.Font(FAmethystStyle::Get().GetFontStyle("AmethystForest.ChatFont"))
