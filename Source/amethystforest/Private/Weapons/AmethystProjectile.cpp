...
#include "Effects/AmethystExplosionEffect.h"

AAmethystProjectile::AAmethystProjectile(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void AAmethystProjectile::Explode(const FHitResult& Impact)
{
	...
	if (ExplosionTemplate)
	{
		...
		AAmethystExplosionEffect* const EffectActor = GetWorld()->SpawnActorDeferred<AAmethystExplosionEffect>(ExplosionTemplate, SpawnTransform);
		if (EffectActor)
		{
