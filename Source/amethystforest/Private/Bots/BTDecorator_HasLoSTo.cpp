...
bool UBTDecorator_HasLoSTo::LOSTrace(AActor* InActor, AActor* InEnemyActor, const FVector& EndLocation) const
{
	...
	AAmethystAIController* MyController = Cast<AAmethystAIController>(InActor);
				...
				if (Hit.GetActor() != NULL)
				{
					...
					else
					{
							...
							&& (MyController->PlayerState != NULL) && (HitChar->PlayerState != NULL))
						{
							...
							AAmethystPlayerState* MyPlayerState = Cast<AAmethystPlayerState>(MyController->PlayerState);
