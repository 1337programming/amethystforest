...
#pragma once
#include "AmethystPersistentUser.generated.h"

UCLASS()
class UAmethystPersistentUser : public USaveGame
{
	GENERATED_UCLASS_BODY()

public:
	/** Loads user persistence data if it exists, creates an empty record otherwise. */
	static UAmethystPersistentUser* LoadPersistentUser(FString SlotName, const int32 UserIndex);
