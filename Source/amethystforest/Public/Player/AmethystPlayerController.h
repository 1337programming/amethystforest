...
#include "Online.h"
#include "AmethystPlayerController.generated.h"

class AAmethystHUD;

UCLASS(config=Game)
class AAmethystPlayerController : public APlayerController
{
...
// 	virtual void Emote(const FString& Msg);
	...
	// begin AAmethystPlayerController-specific
	...
	// end AAmethystPlayerController-specific
...
protected:
	...
	float AmethystFriendUpdateTimer;
