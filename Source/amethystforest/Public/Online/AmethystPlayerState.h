...
#include "AmethystPlayerState.generated.h"

UCLASS()
class AAmethystPlayerState : public APlayerState
{
	...
	void ScoreKill(AAmethystPlayerState* Victim, int32 Points);

	/** player died */
	void ScoreDeath(AAmethystPlayerState* KilledBy, int32 Points);
	...
	void InformAboutKill(class AAmethystPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AAmethystPlayerState* KilledPlayerState);

	/** broadcast death to local clients */
	UFUNCTION(Reliable, NetMulticast)
	void BroadcastDeath(class AAmethystPlayerState* KillerPlayerState, const UDamageType* KillerDamageType, class AAmethystPlayerState* KilledPlayerState);
