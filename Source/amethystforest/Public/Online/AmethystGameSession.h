...
#include "AmethystForestSession.generated.h"

struct FAmethystForestSessionParams
{
...
UCLASS(config=Game)
class SHOOTERGAME_API AAmethystForestSession : public AGameSession
{
...
protected:
	...
	FAmethystForestSessionParams CurrentSessionParams;
	/** Current host settings */
	TSharedPtr<class FAmethystOnlineSessionSettings> HostSettings;
	/** Current search settings */
	TSharedPtr<class FAmethystOnlineSearchSettings> SearchSettings;
	 ...
	 */
	DECLARE_EVENT_TwoParams(AAmethystForestSession, FOnCreatePresenceSessionComplete, FName /*SessionName*/, bool /*bWasSuccessful*/);
	...
	DECLARE_EVENT_OneParam(AAmethystForestSession, FOnJoinSessionComplete, EOnJoinSessionCompleteResult::Type /*Result*/);
	FOnJoinSessionComplete JoinSessionCompleteEvent;

	/*
	 * Event triggered after session search completes
	 */
	//DECLARE_EVENT(AAmethystForestSession, FOnFindSessionsComplete);
	DECLARE_EVENT_OneParam(AAmethystForestSession, FOnFindSessionsComplete, bool /*bWasSuccessful*/);
