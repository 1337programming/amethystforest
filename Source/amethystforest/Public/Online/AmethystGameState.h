...
#include "AmethystForestState.generated.h"

/** ranked PlayerState map, created from the GameState */
typedef TMap<int32, TWeakObjectPtr<AAmethystPlayerState> > RankedPlayerMap;

UCLASS()
class AAmethystForestState : public AGameState
{
