...
#include "AmethystWeapon_Instant.generated.h"

class AAmethystImpactEffect;
...
UCLASS(Abstract)
class AAmethystWeapon_Instant : public AAmethystWeapon
{
...
protected:
	...
	TSubclassOf<AAmethystImpactEffect> ImpactTemplate;
