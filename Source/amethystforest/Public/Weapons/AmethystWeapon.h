...
class AAmethystWeapon : public AActor
{
	...
	virtual void OnEquip(const AAmethystWeapon* LastWeapon);
	...
	virtual void OnEnterInventory(AAmethystCharacter* NewOwner);
	...
	class AAmethystCharacter* GetPawnOwner() const;
	...
	void SetOwningPawn(AAmethystCharacter* AAmethystCharacter);
...
protected:
	...
	class AAmethystCharacter* MyPawn;
...
protected:
	...
	virtual void FireWeapon() PURE_VIRTUAL(AAmethystWeapon::FireWeapon,);
